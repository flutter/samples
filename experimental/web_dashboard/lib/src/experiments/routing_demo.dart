...
void main() {
  runApp(RoutingDemoApp());
}

/// A responsive dashboard using AdaptiveScaffold and NavigationRail with named
/// routes. Routing works as expected using a few tricks.
class RoutingDemoApp extends StatefulWidget {
  @override
  _RoutingDemoAppState createState() => _RoutingDemoAppState();
}

class _RoutingDemoAppState extends State<RoutingDemoApp> {
  @override
