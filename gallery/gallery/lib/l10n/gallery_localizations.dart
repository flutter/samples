...
class GalleryLocalizations {
  ...
  String get dataTableColumnCalories {
    return Intl.message(r'Calories',
        locale: _localeName,
  ...
  String get dataTableColumnDessert {
    return Intl.message(r'Dessert (1 serving)',
        locale: _localeName,
  ...
  String get dataTableColumnProtein {
    return Intl.message(r'Protein (g)',
        locale: _localeName,
  ...
  String get dataTableColumnSodium {
    return Intl.message(r'Sodium (mg)',
        locale: _localeName,
  ...
  String get dataTableHeader {
    return Intl.message(r'Nutrition',
        locale: _localeName,
  ...
  String get dataTableRowFrozenYogurt {
    return Intl.message(r'Frozen yogurt',
        locale: _localeName,
  ...
  String get dataTableRowGingerbread {
    return Intl.message(r'Gingerbread',
        locale: _localeName,
  ...
  String get dataTableRowHoneycomb {
    return Intl.message(r'Honeycomb',
        locale: _localeName,
  ...
  String get dataTableRowJellyBean {
    return Intl.message(r'Jelly bean',
        locale: _localeName,
  ...
  String get dataTableRowLollipop {
    return Intl.message(r'Lollipop',
        locale: _localeName,
  ...
  String dataTableRowWithHoney(Object value) {
    return Intl.message(r'$value with honey',
        locale: _localeName,
  ...
  String dataTableRowWithSugar(Object value) {
    return Intl.message(r'$value with sugar',
        locale: _localeName,
  ...
  String get demo2dTransformationsDescription {
    return Intl.message(
        r'Tap to edit tiles, and use gestures to move around the scene. Drag to pan, pinch to zoom, rotate with two fingers. Press the reset button to return to the starting orientation.',
        locale: _localeName,
  ...
  String get demo2dTransformationsEditTooltip {
    return Intl.message(r'Edit tile',
        locale: _localeName,
        name: 'demo2dTransformationsEditTooltip',
        desc: r'Tooltip for a button to edit a tile.');
  }

  String get demo2dTransformationsResetTooltip {
    return Intl.message(r'Reset transformations',
        locale: _localeName,
        name: 'demo2dTransformationsResetTooltip',
        desc:
            r'Tooltip for a button to reset the transformations (scale, translation) for the 2D transformations demo.');
  }

  String get demo2dTransformationsSubtitle {
    return Intl.message(r'Pan, zoom, rotate',
        locale: _localeName,
  ...
  String get demo2dTransformationsTitle {
    return Intl.message(r'2D transformations',
        locale: _localeName,
  ...
  String get demoCupertinoPickerDateTime {
    return Intl.message(r'Date and Time',
        locale: _localeName,
  ...
  String get demoCupertinoPickerDescription {
    return Intl.message(
        r'An iOS-style picker widget that can be used to select dates, times, or both date and time.',
        locale: _localeName,
  ...
  String get demoCupertinoPickerSubtitle {
    return Intl.message(r'iOS-style date and time pickers',
        locale: _localeName,
  ...
  String get demoDataTableDescription {
    return Intl.message(
        r'Data tables display information in a grid-like format of rows and columns. They organize information in a way that’s easy to scan, so that users can look for patterns and insights.',
        locale: _localeName,
  ...
  String get demoDataTableSubtitle {
    return Intl.message(r'Rows and columns of information',
        locale: _localeName,
  ...
  String get demoDataTableTitle {
    return Intl.message(r'Data Tables',
        locale: _localeName,
