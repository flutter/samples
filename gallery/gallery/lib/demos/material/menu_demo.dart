  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.type) {
          ...
          trailing: PopupMenuButton<String>(
            ...
            itemBuilder: (context) => <PopupMenuItem<String>>[
              PopupMenuItem<String>(
                value: GalleryLocalizations.of(context).demoMenuItemValueOne,
                child: Text(
              ...
              PopupMenuItem<String>(
                value: GalleryLocalizations.of(context).demoMenuItemValueThree,
                child: Text(
      ...
      case MenuDemoType.simpleMenu:
        ...
        menu = PopupMenuButton<SimpleValue>(
          padding: EdgeInsets.zero,
