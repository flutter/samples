...
class GalleryLocalizations {
  ...
  String get homeCategoryReference {
    return Intl.message('STYLES & OTHER',
        ...
        desc:
            r'Category title on home screen for styles & other demos (for context, the styles demos consist of a color demo and a typography demo).');
  }
  ...
  String rallyAlertsMessageCheckingAccount(Object percent) {
    return Intl.message(
        ...
        desc: r'Alert message shown when for example, the checking account is 1% higher than last month.',
        args: <Object>[percent]);
  }
  ...
  String get rallyBillDetailAmountDue {
    return Intl.message('Amount Due',
        locale: _localeName,
        name: 'rallyBillDetailAmountDue',
        desc:
            r'Title for column where it displays the amount that the user has due.');
  }

  String get rallyBillDetailAmountPaid {
    return Intl.message('Amount Paid',
        locale: _localeName,
        name: 'rallyBillDetailAmountPaid',
        desc:
            r'Title for column where it displays the amount that the user has paid.');
  }
  ...
  String get rallyBillDetailTotalAmount {
    return Intl.message('Total Amount',
        ...
        desc:
            r'Title for column where it displays the total dollar amount that the user has in bills.');
  }
  ...
  String get rallyBudgetDetailAmountLeft {
    return Intl.message('Amount Left',
        locale: _localeName,
        name: 'rallyBudgetDetailAmountLeft',
        desc:
            r'Title for column where it displays the dollar amount that the user has left in its budget.');
  }

  String get rallyBudgetDetailAmountUsed {
    return Intl.message('Amount Used',
        locale: _localeName,
        name: 'rallyBudgetDetailAmountUsed',
        desc:
            r'Title for column where it displays the dollar amount that the user has used in its budget.');
  }

  String get rallyBudgetDetailTotalCap {
    return Intl.message('Total Cap',
        locale: _localeName,
        name: 'rallyBudgetDetailTotalCap',
        desc:
            r'Title for column where it displays the total dollar cap that the user has for its budget.');
  }
